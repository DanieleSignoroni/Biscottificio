...
public abstract class YAnagrSpecProdPO extends EntitaAzienda implements BusinessObject, Authorizable, Deletable, Conflictable {
  ...
  /**
   * Attributo iTitoloSpecifica
   */
  protected String iTitoloSpecifica;
   ...
   *
   */
  public void setTitoloSpecifica(String titoloSpecifica) {
    this.iTitoloSpecifica = titoloSpecifica;
    setDirty();
  }
   ...
   *
   */
  public String getTitoloSpecifica() {
    return iTitoloSpecifica;
  }
